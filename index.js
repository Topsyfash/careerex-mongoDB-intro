...
const MONGODB_URL = "mongodb+srv://fasogba:Ayfash@cluster0.h36vivy.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
...
app.put("/update-item",async (req,res) => {
    ...
    const updatedItem = await Item.findByIdAndUpdate(id, { description, claimed },
        { new: true }
    )
